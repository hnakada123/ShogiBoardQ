...
JosekiMoveDialog::JosekiMoveDialog(QWidget *parent, bool isEdit)
    : QDialog(parent)
    , m_moveBoardRadio(nullptr)
    , m_moveDropRadio(nullptr)
    , m_moveTypeGroup(nullptr)
    , m_moveFromFileCombo(nullptr)
    , m_moveFromRankCombo(nullptr)
    ...
    , m_moveBoardWidget(nullptr)
    , m_moveDropWidget(nullptr)
    , m_nextMoveBoardRadio(nullptr)
    , m_nextMoveDropRadio(nullptr)
    , m_nextMoveNoneRadio(nullptr)
    , m_nextMoveTypeGroup(nullptr)
    , m_nextMoveFromFileCombo(nullptr)
    , m_nextMoveFromRankCombo(nullptr)
