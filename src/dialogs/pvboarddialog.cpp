...
void PvBoardDialog::buildUi()
{
    ...
    m_btnBack = new QPushButton(QStringLiteral("◀"), this);
    m_btnBack->setMinimumWidth(100);
    m_btnBack->setToolTip(tr("1手戻る"));
    m_btnBack->setAccessibleName(tr("1手戻る"));
    ...
    m_btnForward = new QPushButton(QStringLiteral("▶"), this);
    m_btnForward->setMinimumWidth(100);
    m_btnForward->setToolTip(tr("1手進む"));
    m_btnForward->setAccessibleName(tr("1手進む"));
