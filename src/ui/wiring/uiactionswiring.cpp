...
void UiActionsWiring::wire()
{
    ...
    if (!m_fileWiring) {
        m_fileWiring = new FileActionsWiring({m_d.ui, mw}, this);
        m_gameWiring = new GameActionsWiring({m_d.ui, mw}, this);
        m_editWiring = new EditActionsWiring({m_d.ui, mw, mw->kifuExportController()}, this);
        m_viewWiring = new ViewActionsWiring({m_d.ui, mw}, this);
    }
